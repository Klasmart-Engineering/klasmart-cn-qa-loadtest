...
export default function main() {
  const response = learnOutcomeAchievement();
  return response;
}

export function learnOutcomeAchievement(){
  var url = `${env.Loadtest_URL}/v1/reports/student_progress/learn_outcome_achievement?org_id=${env.ORG_ID}`;
  let data = {
  "class_id": "facc1eaa-0f7c-4f97-9346-3fd945a7d4f4",
  "durations": [
//    dateTimestamp(140) + '-' + dateTimestamp(28),
    "1640793600-1650470400"
    "1651420800-1652025600",
    "1652025600-1652630400",
    "1652630400-1652946165"
  ],
  ...
  "student_id": "17a28338-3b88-4bac-ab15-cce3887af357",
